...
//   void _taiTinNhanRealTime() {
//     if (_maCuocTroChuyenId != null) {
//       _dichVuTinNhan.langNgheTinNhanRealTime(_maCuocTroChuyenId!).listen((danhSach) {
//         if (mounted) {
//           setState(() {
...
//       _dichVuTinNhan.danhDauDaDoc(_maCuocTroChuyenId!, 'current_user');
//     }
//   }
...
//     try {
//       await _dichVuTinNhan.guiTinNhanRealTime(
...
class _ManHinhChiTietTinNhanState extends State<ManHinhChiTietTinNhan>
  ...
  // Cập nhật phương thức xây dựng tin nhắn để hiển thị bong bóng chat

  Widget _xayDungTinNhan(TinNhan tinNhan, bool laTinNhanCuaToi, int index) {
    // Nếu không hiển thị bong bóng, trả về widget trống
    if (!tinNhan.hienThiBongBong) {
