  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                ...
                FlutterCarousel(
                  items: [
                    _xayDungBanner(
                      ...
                      'assets/images/hinhnen1.jpg', // Thay banner1.jpg bằng recipe_1.jpg
                      () {},
                    ),
                    _xayDungBanner(
                      'Món Ngon Mùa Hè',
                      'Những món ăn giải nhiệt cho ngày nắng nóng',
                      'assets/images/hinhnen2.jpg', // Thay banner1.jpg bằng recipe_1.jpg
                      () {},
                    ),
                    _xayDungBanner(
                      'Cùng Nấu Ăn Tại Nhà',
                      'Tiết kiệm chi phí với các công thức đơn giản',
                      'assets/images/hinhnen3.jpg', // Thay banner1.jpg bằng recipe_1.jpg
                      () {},
                    ),
                  ],
      ...
      floatingActionButton: FloatingActionButton(
        ...
        backgroundColor: ChuDe.mauChinh, // nếu muốn dùng màu theme của bạn
