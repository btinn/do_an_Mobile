...
//   Stream<List<TinNhan>> langNgheTinNhanRealTime(String cuocTroChuyenId) {
//     return _database
//         .child('tin_nhan')
//         .child(cuocTroChuyenId)
//         .orderByChild('thoiGian')
...
//   Future<void> capNhatTrangThaiOnline(String maNguoiDung, bool online) async {
//     await _database.child('users_online').child(maNguoiDung).set({
//       'online': online,
...
//   Stream<bool> langNgheTrangThaiOnline(String maNguoiDung) {
//     return _database
//         .child('users_online')
//         .child(maNguoiDung)
//         .child('online')
...
//   // Gửi tin nhắn real-time với notification
//   Future<void> guiTinNhanRealTime({
//     required String maNguoiGui,
//     required String tenNguoiGui,
//     required String anhNguoiGui,
//     required String maNguoiNhan,
...
//     await _capNhatCuocTroChuyenTomTatRealTime(cuocTroChuyenId, tinNhan);

//     // Gửi notification cho người nhận
//     await _guiThongBaoTinNhanMoi(maNguoiNhan, tenNguoiGui, noiDung);
//   }

//   // Cập nhật cuộc trò chuyện tóm tắt real-time
//   Future<void> _capNhatCuocTroChuyenTomTatRealTime(
//       String cuocTroChuyenId, Map<String, dynamic> tinNhan) async {
//     final cuocTroChuyenTomTat = {
//       'tinNhanCuoi': tinNhan['noiDung'],
//       'loaiTinNhanCuoi': tinNhan['loai'],
...
//     // Cập nhật cho người nhận
//     final nguoiNhanSnapshot = await _database
//         .child('cuoc_tro_chuyen')
//         .child(tinNhan['maNguoiNhan'])
//         .child(cuocTroChuyenId)
//         .child('soTinNhanChuaDoc')
...
//     final soTinNhanChuaDocHienTai = nguoiNhanSnapshot.exists 
//         ? (nguoiNhanSnapshot.value as int? ?? 0) 
//         : 0;
...
//       'tenNguoiKhac': tinNhan['tenNguoiGui'],
//       'anhNguoiKhac': tinNhan['anhNguoiGui'],
//       'soTinNhanChuaDoc': soTinNhanChuaDocHienTai + 1,
//     });
//   }

//   // Gửi thông báo tin nhắn mới
//   Future<void> _guiThongBaoTinNhanMoi(String maNguoiNhan, String tenNguoiGui, String noiDung) async {
//     final thongBaoId = DateTime.now().millisecondsSinceEpoch.toString();
//     await _database.child('thong_bao').child(maNguoiNhan).child(thongBaoId).set({
//       'loai': 'tin_nhan',
